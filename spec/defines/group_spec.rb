...
describe 'hbm::manage::group' do
  ...
  on_supported_os.sort.each do |os, os_facts|
    ...
    context "on #{os} with ensure set to invalid" do
      ...
      it 'fail' do
        expect { is_expected.to contain_class(:subject) }.to raise_error(Puppet::Error, %r{hbm::manage::group::testing::ensure is invalid and does not match the regex.})
      end
    end
  end
end
